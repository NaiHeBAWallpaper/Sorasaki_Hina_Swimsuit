...
let customScale = 1;
let targetFps = 60;
let bgmfile = './assets/audio/Midnight Trip.flac';
let bgmvolume = 0;
let bgm;
...
const AUDIO_DETAIL = [
	{
		...
		dialog: {
			...
			English: [
				"Why does everyone love the ocean so much...? I've always wondered.",
				"Everyone seems to be having fun, but I just can't bring myself to like it..."
			],
			Chinese: [
				"为什么大家都那么喜欢大海呢……我一直在思考。",
				"虽然大家看起来很开心，但是我却怎么也喜欢不上…"
			]
		}
	},
	{
	...
	},
	{
		...
		dialog: {
			...
			English: [
				...
				"Thank you, Sensei...for being here with me. And for everything you've taught me."
			],
			Chinese: [
				"不可思议……到现在为止，明明没有这样想过。",
				"谢谢你，老师。陪着我……告诉我各种各样的事情。"
			]
		}
	}
];
...
const HITBOX = {
	headpat: { xMin: 1400, xMax: 1820, yMin: 50, yMax: 350 },
	voiceline: { xMin: 1270, xMax: 1750, yMin: 680, yMax: 1600 }
};
